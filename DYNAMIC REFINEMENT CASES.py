...
#########################################################################
#########################################################################
#---This function stores indexes of bounday elemnts of each elements----#
#########################################################################
...
def L_Norm_Image(x,y,x_sub,y_sub,n,Nel,Nop,Nopx,Nop_m,Nopx_m,Nelxy,T_step,qn,qn_sub):
    ...
    fileName = "/home/sivakesava/Fig0202/image-%04d.png" %it_no
...
#########################################################################
#########################################################################
print '-------------DYNAMIC REFINEMENT FOR DIFFERENT CASES------------ \n'
Option=1
for case in range(5):
   if case==0:
      print'N=1'
      ...
      print'N=8'
      N,Steps,E_size=8,4,[1,2,3,4,5,6]
...
#p=subprocess.call(['mkdir', '/home/sivakesava/Fig0202'])# Creating a folder to save the images
      for Time in range(T):
         T_step=T_step+dt
